...
(function () {
  ...
  const FRAG = `
    ...
    void main() {
      ...
      vec3 base   = vec3(0.86, 0.91, 1.0);                         // pure white
      vec3 tint   = vec3(0.28, 0.52, 1.0);             // clear pastel ice-blue
      vec3 accent = vec3(0.1, 0.22, 1.0);             // saturated vibrant blue for peak refraction
