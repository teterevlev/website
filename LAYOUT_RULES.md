...
Правила извлечены из `maket/index.html`, `revlev.ru/css/maket.css`, `background.js` и `building-scene.js`. Соблюдать при доработке страницы и при переносе в другие экраны/проекты.
